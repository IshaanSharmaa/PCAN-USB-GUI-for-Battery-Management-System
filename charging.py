...
df = pd.DataFrame(columns=[
    ...
    'Number Of Cycles', 'RSOC', 'NTC1', 'NTC2', 'NTC3', 'V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V7', 'V8', 'V9', 'V10', 'V11', 'V12',
    'V13', 'V14', 'V15'
])
    ...
    def pcan(self):
        ...
        while (self.ui.pushButton.isChecked()):      
            ...
            for i in range(8):
                ...
                can_id = list(dict.keys())[i]
                id_list = list(dict.values())[i]
 

                can_data = "Remote Request"
                #Writing in Data
                while (can_data == "Remote Request"):
                    
                    pcan.Uninitialize(PCAN_USBBUS1)
                    inintialize = pcan.Initialize(PCAN_USBBUS1, PCAN_BAUD_250K)                       
